<div class="h60 d-flex align-items-center justify-content-center position-relative bg-img"><div class="black-overlay"></div><h1 class="mt-5 text-light position-relative">OUR EVENTS</h1></div>
<div class="w-100 d-flex flex-column align-items-center justify-content-evenly py-4 my-3">
  ...
  <div class="container col-10 pb-5 my-md-2">
    <!-- <h2 class="primary-color py-3 text-center">Our Events</h2> -->
    <div class="row p-3 p-md-2">
      <div class="overflow-auto h70">
          <div class="w-100 px-1">
            <div class="row">
              <a href="#" class="col-sm-6 col-md-4 col-lg-3 mb-4">
